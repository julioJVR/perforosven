    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('descripcion', models.TextField(blank=True, null=True)),
                ('tipo', models.CharField(choices=[('ACTIVO', 'Activo'), ('PASIVO', 'Pasivo'), ('PATRIMONIO', 'Patrimonio'), ('INGRESO', 'Ingreso'), ('COSTO', 'Costo'), ('GASTO', 'Gasto')], default='ACTIVO', max_length=20)),
                ('naturaleza', models.CharField(choices=[('D', 'Deudora'), ('A', 'Acreedora')], default='D', max_length=1)),
                ('nivel', models.PositiveSmallIntegerField(default=1)),
                ('es_activo', models.BooleanField(default=True)),
                ('padre', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='hijas', to='contabilidad.cuentacontable')),
            ],
            options={
